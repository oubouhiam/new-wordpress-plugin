...
function wphw_opt(){
    ...
    $link = mysqli_connect("localhost", "root", "", "website1");
    $sql = "CREATE TABLE YouCodeP(id int NOT NULL PRIMARY KEY AUTO_INCREMENT, username varchar(255) NOT NULL, descriptions varchar(255) NOT NULL, Options varchar(255) NOT NULL)";
...
function insert(){
    ...
    {
         $query="insert INTO YouCodeP (username,descriptions,Options)". "VALUES ('$username', '$descriptions', '$Options')";
